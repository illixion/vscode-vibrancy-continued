...
* acrylic, mica, tabbed: (Windows 10 only) Fluent Design blur types.
* under-window, fullscreen-ui, appearance-based, light, dark, titlebar, selection, menu, popover, sidebar, medium-light, ultra-dark: macOS only types.
